<x-guest-layout>
    <x-auth-card>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <!-- job -->
            <div>
                <x-label for="job" :value="__('الوظيفة')" />
            ...
            <div>
                ...
                <select name="gender" class="block mt-1 w-full" id="gender" :value="old('gender')">
                    <option class="block mt-1 w-full" value="male">رجل</option>
                    <option class="block mt-1 w-full" value="female" selected>إمراة</option>
                </select>
